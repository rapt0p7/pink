...
gulp.task('server', function () {
	browserSync.init({                                // запускаем локальный сервер (показ, автообновление, синхронизацию)
    	...
    	// tunnel		: "rapt0p7"                   // наименование сайта для доступа из внешней сети (вида site-name.localtunnel.me)
    ...
    .pipe( svgSprite({
        ...
        mode: {
            css: {
                dest   : "./",
                layout : "diagonal",
                sprite : "../img/icon-sprite.svg",                    // путь к спрайту указваемый в конечном css файле
                bust   : false,
                render : {
                    less: {
